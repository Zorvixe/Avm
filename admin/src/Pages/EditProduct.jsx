  ...
  return (
    <div className="add-prod-container">
      ...
      <form onSubmit={saveProduct} className="add-prod-premium-form">
        ...
        <div className="add-prod-form-section">
          <div className="add-prod-section-header">
          ...
          <div className="add-prod-variant-list">
            {variants.map((variant, index) => (
              <div key={variant.id} className="add-prod-variant-card">
                <div className="add-prod-variant-header">
                  <strong>Variant {index + 1}</strong>
                  {variants.length > 1 && (
                    <button type="button" className="add-prod-remove-variant" onClick={() => removeVariant(index)}>
                      Remove
                    </button>
                  )}
                </div>
                <div className="add-prod-form-row">
                  <div className="add-prod-form-group">
                    ...
                    <input type="text" value={variant.variant_name || ""} onChange={(e) => updateVariant(index, "variant_name", e.target.value)} placeholder="e.g. 500ml" />
                  </div>
                  <div className="add-prod-form-group">
                    <label>Quantity</label>
                    <input type="number" step="0.01" value={variant.quantity || ""} onChange={(e) => updateVariant(index, "quantity", e.target.value)} placeholder="500" />
                  </div>
                  <div className="add-prod-form-group">
                    <label>Unit</label>
                    <input type="text" value={variant.unit || ""} onChange={(e) => updateVariant(index, "unit", e.target.value)} placeholder="ml" />
                  </div>
                </div>
                <div className="add-prod-form-row">
                  <div className="add-prod-form-group">
