    ...
    <div className="policy-page">
      <div className="container">
        ...
        <section>
          ...
          <p>
            At <strong>AVM</strong>, we are committed to delivering your luxury sarees safely and on time. We have partnered with <strong>Shiprocket</strong>, India's leading logistics aggregator, to provide reliable nationwide shipping and real-time tracking.
          </p>
        </section>
