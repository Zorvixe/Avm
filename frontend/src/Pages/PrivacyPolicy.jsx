    ...
    <div className="policy-page">
      <div className="container">
        ...
        <section className="premium-policy-text">
          <p>
            “At <strong>AVM</strong>, your privacy is our priority. We ensure that all your personal information is securely protected and used only to enhance your shopping experience. Your details are never shared with third parties without your consent.”
          </p>
        </section>
