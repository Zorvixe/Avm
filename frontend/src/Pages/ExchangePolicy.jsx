    ...
    <div className="policy-page">
      <div className="container">
        ...
        <section className="premium-policy-text">
          <p>
            “At <strong>AVM</strong>, we offer exchange options to ensure your satisfaction. Exchanges are accepted only if an unboxing video is recorded and shared. The product must be unused and in original condition. Requests without a proper opening video will not be accepted.”
          </p>
        </section>
